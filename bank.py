...
class CheckingAccount(Account):
    ...
    def debit(self,damt):
       ...
       if (check):
        self.cbal-=self.tc
        print("A transcation of Rs"+str(self.tc),"is charged for previous transaction Available balance is"+str(self.cbal))
    ...
    def credit(self,cram):
        ...
        if (check):
            self.cbal -= self.tc
            print("A transcation charge of Rs" + str(self.tc), "is charged for previous transaction Available balance is"+str(self.cbal))
...
c1=CurrentAccount("avdhesh","dihuli",1000,000,1000)
c1.debit(1000)
